...
@shared_task(max_retries=2, default_retry_delay=10, autoretry_for=TRANSIENT_ERRORS)
...
@shared_task(max_retries=1, default_retry_delay=60, autoretry_for=TRANSIENT_ERRORS)
